...
function StatItem({ stat }) {
  ...
  const { display, start } = useCountUp(stat.value, 2000, stat.suffix);
  ...
  return (
    ...
    >
      <div className="wrap">
        ...
        >
          <img
            src="/hero-structure.jpg"
            alt="SkillHub Digital Agency"
            style={{
              width: "100%",
              height: "100%",
              objectFit: "cover",
          ...
          >
            ...
            >
              SkillHub partners with businesses, governments and institutions to
              design, build, secure and grow modern digital products.
            </div>
          </motion.div>
